...
namespace dRd
{
    public partial class T_7_DataAugmentation_Rotate : Form
    {
        ...
        public T_7_DataAugmentation_Rotate()
        {
            InitializeComponent();
            pictureBox1.Image = (System.Drawing.Image)Program.cropped;
        }
        ...
        {
            T_8_Features obj = new T_8_Features();
            ActiveForm.Hide();
            obj.Show();
        }
    }
